...
export default function PrimaryDataPreset1({ endpoints={} }) {
  ...
  useEffect(() => {
    ...
    else humidityMuteNode.gain.linearRampToValueAtTime(rescaleVolume(volume * 1.5), audioCtx.currentTime + 0.01);
  }, [variable3Mute]);
...
useEffect(() => {
  ...
  return (
    <PageLayout title='Primary Data Preset 1' backLink='primary-data' help helpOnClick={helpClick} dataControls treeOnClick={treeClick} aboutOnClick={aboutClick}>
      {
          loading
            ? <h4>Loading...</h4>
            : hide
