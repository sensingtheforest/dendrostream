...
export default function AboutDerivedData({ children, referenceTone=true, dualSonification=false, variability=false, ambience=false, displacementMapping='', soilMoistureMapping='', temperatureMapping='', humidityMapping='', vpd=false, vpdMapping='', treeMeanGrowth=false, treeMeanGrowthMapping='', aboutPage=false }) {
    // Properties ----------------------------------
    // Hooks ---------------------------------------
    // Context -------------------------------------
    // Methods -------------------------------------
    ...
    return (
        <div>
            ...
            <p style={{ textAlign: 'left' }}>This presentation offers sonification and visualisation of the tree and climate data, both received directly from the sensors of the hardware tree talker device, installed on a tree, and calculated based on the available data. Further information on the meanings{aboutPage ? ' and observations' : ', observations, and mappings'} of the sensor and derived data variables being shown, is provided below.</p>
                    ...
                    <>
                        ...
                        { 
                            !aboutPage && (
                                <>
                                    <h6 style={{ textAlign: 'left' }}>Mapping</h6>
                                    <p style={{ textAlign: 'left' }}>{vpdMapping}</p>
                                </>
                            )
                        }
                    </>
                    ...
                    <>
                        ...
                        { 
                            !aboutPage && (
                                <>
                                    <h6 style={{ textAlign: 'left' }}>Mapping</h6>
                                    <p style={{ textAlign: 'left' }}>{treeMeanGrowthMapping}</p>
                                </>
                            )
                        }
                    </>
